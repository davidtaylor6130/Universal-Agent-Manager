...
namespace ollama_engine::internal::vectorised_rag
{
	...
	bool Scan(Context& pContext, const std::optional<std::string>& pOptSVectorFile, const RuntimeOptions& pRuntimeOptions, std::string* pSErrorOut = nullptr);
	...
	bool LoadRagDatabases(Context& pContext, const std::vector<std::string>& pVecSDatabaseInputs, const RuntimeOptions& pRuntimeOptions, std::string* pSErrorOut = nullptr);
