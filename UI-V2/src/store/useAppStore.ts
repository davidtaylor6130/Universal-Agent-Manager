...
import {
  ...
  sanitizeCliVersionManager,
  sanitizeCliVersionProviderState,
  stringOr,
...
import {
  ...
  MAX_CLI_TRANSCRIPT_BYTES,
  messageBlocksEquivalent,
  normalizeAcpLifecycleState,
  normalizeCliLifecycleState,
  normalizeCliTranscript,
  normalizeProviderIdForVisibleProviders,
  planEntriesEquivalent,
