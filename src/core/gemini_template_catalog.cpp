...
std::vector<TemplateCatalogEntry> GeminiTemplateCatalog::List(const std::filesystem::path& global_root) {
  ...
  std::sort(entries.begin(), entries.end(), [](const TemplateCatalogEntry& lhs, const TemplateCatalogEntry& rhs) {
...
bool GeminiTemplateCatalog::ResolveTemplatePath(const std::filesystem::path& global_root,
                                                const std::string& id,
...
bool GeminiTemplateCatalog::ImportMarkdownTemplate(const std::filesystem::path& global_root,
                                                   const std::filesystem::path& source_file,
                                                   std::string* imported_id_out,
                                                   std::string* error_out) {
...
bool GeminiTemplateCatalog::RenameTemplate(const std::filesystem::path& global_root,
                                           const std::string& id,
...
bool GeminiTemplateCatalog::RemoveTemplate(const std::filesystem::path& global_root,
                                           const std::string& id,
                                           std::string* error_out) {
