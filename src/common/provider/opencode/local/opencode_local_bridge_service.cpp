...
namespace
{
	...
	{
		OpenCodeLocalBridgeService bridge_service;
...
bool OpenCodeLocalBridgeService::EnsureRunning(AppState& app,
...
void OpenCodeLocalBridgeService::Stop(AppState& app, const bool keep_token) const
{
