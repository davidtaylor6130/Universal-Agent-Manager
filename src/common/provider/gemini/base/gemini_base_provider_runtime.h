...
class GeminiBaseProviderRuntime : public IProviderRuntime
{
  public:
  ...
  protected:
	GeminiBaseProviderRuntime(const char* runtime_id, bool enabled, const char* disabled_reason, bool uses_cli_output);
