...
inline void DrawFolderSettingsModal(AppState& app)
{
	...
	DrawPathInputWithBrowseButton("Directory##folder_settings_directory", app.folder_settings_directory_input, "folder_settings_directory_picker", PathBrowseTarget::Directory, 460.0f, nullptr, nullptr, &browse_error);
